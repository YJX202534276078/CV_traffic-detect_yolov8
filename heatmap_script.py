...
def get_params():
    params = {
        'weight': str(REPO_ROOT / 'Traffic_detection_project/Traffic_detection_train/results/roboflow_721_EIoU_yolov8n/weights/best.pt'), # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(str(REPO_ROOT / 'Traffic_detection_project/Traffic_detection_dataset/images_videos_test/p23.jpg'), 'heatmap_result')
